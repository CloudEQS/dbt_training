...
select  
    ...
    , oli.total_price as amount --"annual bookings amount" (unconverted)
...
join {{ ref('opportunity_details_int') }} oli on oli.opportunity_id = o.opportunity_id and CAST(oli.li_deleted AS BOOLEAN) = FALSE
...
and o.stage = '6-closed won' --only include closed/won opps
